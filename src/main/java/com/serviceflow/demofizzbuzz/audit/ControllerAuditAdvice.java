package com.serviceflow.demofizzbuzz.audit;

import com.serviceflow.demofizzbuzz.utils.MyUtils;
...
public class ControllerAuditAdvice {
     ...
     * @throws Throwable
     */
    @Around("execution(public * com.serviceflow.demofizzbuzz.stereotypes.controllers..*Controller.*(..)) && @annotation(audit) ")
